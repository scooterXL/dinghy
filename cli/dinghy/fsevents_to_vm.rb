...
class FseventsToVm
  ...
  def install_if_necessary!
    ...
    system!("installing", "sudo", "/System/Library/Frameworks/Ruby.framework/Versions/Current/usr/bin/gem", "install", "--no-rdoc", "--no-ri",
            "-n", "/usr/local/bin", "fsevents_to_vm", "-v", VERSION)
  end
